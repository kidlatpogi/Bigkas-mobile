...
const TrainingSetupScreen = ({ navigation }) => {
  ...
  const [selectedFocus, setSelectedFocus] = useState('free');
  ...
  useEffect(() => {
    const loadScripts = async () => {
      ...
      // Auto-select first script of current type
      const firstScript = mockScripts.find((s) => s.type === selectedScriptType);
      if (firstScript) {
