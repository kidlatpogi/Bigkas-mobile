...
| Handler               | Trigger                | Action                              |
| --------------------- | ---------------------- | ----------------------------------- |
| `handlePracticeAgain()` | "Practice Again" press | `navigation.goBack()` or `navigate('TrainingSetup')` |
...
| Action                             | Destination          | Params                                                 |
| ---------------------------------- | -------------------- | ------------------------------------------------------ |
| `navigate('TrainingScripted', ...)` | TrainingScriptedScreen | `{focusMode: 'free', autoStart: true, scriptType: 'autogenerated'}` |
